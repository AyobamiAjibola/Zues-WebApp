...
import User, { $changePassword, $saveUserSchema, $updateUserSchema, IUserModel } from '../models/User';
...
import settings, { CREATE_USER, DELETE_USER, MANAGE_ALL, READ_USER, UPDATE_USER } from '../config/settings';
